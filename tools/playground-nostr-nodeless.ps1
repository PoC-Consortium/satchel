...
# PoCX :18443 (+REST) and BTC :18332 (+REST) sit on bindex's hardcoded ports;
# two electrs (:19750/51 pocx, :19760/61 btc vanilla); relay :19788. The old
# 19443/19543/19643 stay listed to sweep stale classic runs.
$Ports = 9739, 19737, 19738, 19739, 19740, 18443, 18332, 19750, 19751, 19760, 19761, 19443, 19543, 19643, 19788, 19790, 5173
...
$pg = Start-Process -FilePath "python" -ArgumentList "satchel_playground_nostr.py","--nodeless" `
