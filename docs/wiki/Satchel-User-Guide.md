...
> **Warning** — alpha software, real funds. The chain enforces the deal, but the protocol and implementation are under external audit. When you close Satchel with a live swap, the exit gate lets you **keep running** so the engine can finish or refund — heed it.
