...
| `ch14-settings-tabs.png` | 14 — Settings | Settings screen | All five tabs visible (General / Coins / Network / Fees / About) |
| `ch14-fees-tab.png` | 14 — Settings | Settings → Fees tab | The four fee-bumping knobs with Save and Reset to defaults |

22 screenshots total. Filenames use the `chNN-` chapter prefix so assets stay
