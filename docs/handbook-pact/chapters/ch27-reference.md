...
All methods are JSON-RPC over `POST /` — **69 public methods**, grouped by
...
`boardstatus`, `setblocklist`, `getblocklist`, `boardpostoffer`, `boardtake`,
`boardrevoke`, `offerdismiss`, `revokeoffersforcoin`.
