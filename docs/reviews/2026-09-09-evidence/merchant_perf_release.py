...
p=subprocess.Popen([r'C:\code\pocx\satchel\pact\target\release\pactd.exe','--data-dir',str(root),'--network','regtest','--listen',f'127.0.0.1:{port}','--merchants','--tick-secs','0'],stdout=log,stderr=log,env=env,creationflags=0x08000000)
