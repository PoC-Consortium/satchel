...
export const sk: Bundle = {
  ...
  header: {
    ...
    coinOk: "{name} — pripojené · {via} · vrchol {tip}",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} z {total} Electrum serverov je nedostupných — kryjú ich záložné servery.",
    intro:
    ...
    sendOverBalance: "Viac než minuteľný zostatok (vrátane odhadovaného poplatku).",
    feeLabel: "Sieťový poplatok — pripočíta sa k sume",
    fee_slow: "Pomalý",
    fee_normal: "Normálny",
    fee_fast: "Rýchly",
    fee_custom: "Vlastný",
    feeRate: "{rate} sat/vB",
    feeNoEstimate: "žiadne dáta",
    feeNoEstimatesNote: "Momentálne nie sú k dispozícii živé odhady poplatkov — trh s poplatkami môže byť prázdny. Nastavte vlastnú sadzbu.",
    feeCustomLabel: "Vlastná sadzba (sat/vB)",
    feeCustomMin: "Minimum {min} sat/vB.",
    sendFeePreview: "Odhadovaný sieťový poplatok: ~{fee} {sym} pri typickej transakcii.",
    sendReview: "Skontrolovať",
    sendBack: "Späť",
    sendConfirmTitle: "Potvrďte odoslanie ({sym})",
    sendConfirmRecipient: "Príjemca",
    sendConfirmAmount: "Suma",
    sendConfirmFee: "Sieťový poplatok (odhad)",
    sendConfirmFeeValue: "~{fee} {sym} ({rate} sat/vB)",
    sendConfirmTotal: "Spolu (približne)",
    sendIrreversible: "Transakcie sú nezvratné. Dôkladne skontrolujte adresu — mince odoslané na nesprávnu adresu sú stratené.",
    ...
    bump: "Zvýšiť",
    bumpHint: "Zaplaťte vyšší poplatok, aby sa táto čakajúca transakcia potvrdila skôr (RBF).",
    bumpTitle: "Zvýšiť poplatok ({sym})",
    bumpIntro: "Nahraďte túto čakajúcu transakciu novou s vyšším poplatkom (RBF). Teraz platí ~{rate} sat/vB.",
    bumpNeedHigher: "Vyberte sadzbu nad aktuálnych ~{rate} sat/vB.",
    bumpBroadcast: "Poplatok zvýšený — náhradná transakcia {txid}… je na ceste ({sym}).",
    bumpConfirm: "Zvýšiť poplatok",
  },
  corkboard: {
  ...
  relays: {
    title: "Sieť",
    tabNostr: "Nostr",
    serversSubtitle: "Electrum servery pre {coin} — server peňaženky, aktívne pohľady a studené zálohy. Stav sa sleduje len zo skutočnej prevádzky; záložné servery sa nekontaktujú, kým nie sú povýšené.",
    healthyCount: "{healthy} / {total} v poriadku",
    roleWallet: "peňaženka",
    roleView: "pohľad",
    roleStandby: "záloha",
    stateHealthy: "v poriadku",
    stateDown: "nedostupný",
    stateUntested: "neotestovaný",
    retryIn: "nový pokus o {secs} s",
    serverTip: "{requests} požiadaviek · {failures} chýb",
    serverErr: "posledná chyba: {error}",
    noServers: "Táto minca nemá nakonfigurované žiadne Electrum servery.",
  ...
  swaps: {
    ...
    foreignGroup: "Iný stroj · {machine}",
    takeover: "Prevziať",
    takeoverHint:
      "Začnite riadiť swapy tohto stroja tu. Urobte to až keď je ten stroj zastavený.",
  ...
  narrate: {
    locking: "Zamykáme vaše {coin} — zamykacia transakcia práve odchádza. Odteraz vás chránia timelocky; zrušenie už nie je záchranná sieť.",
    awaitingOurLock: "Ďalšia zamyká vaša strana {coin} — odošle ho stroj, ktorý tento swap riadi.",
