...
export const sk: Bundle = {
  ...
  contacts: {
    title: "Kontakty",
    subtitle: "Vaše súkromné prezývky pre ľudí, s ktorými obchodujete.",
    privacyNote:
      "Kontakty sa ukladajú iba na tomto zariadení a nikdy sa nezdieľajú, nepublikujú ani neposielajú na relay. Prezývka je váš štítok — identikon a odtlačok zostávajú skutočnou identitou.",
    searchPlaceholder: "Hľadať prezývku, poznámku alebo kľúč",
    empty: "Zatiaľ žiadne kontakty. Kliknutím na identikon protistrany kdekoľvek ju pridáte.",
    emptyFiltered: "Tomuto filtru nezodpovedajú žiadne kontakty.",
    count: "{n} kontaktov",
    colWho: "Identita",
    colNick: "Prezývka",
    colNote: "Poznámky",
    ...
    colActions: "",
    filterAll: "Všetko",
    filterTrusted: "Dôveryhodné",
    filterBlocked: "Blokované",
    // Corkboard toggle: drop blocked makers' offers from the ladder.
    hideBlocked: "Skryť blokované ponuky",
    statusTrusted: "Dôveryhodný",
    statusNeutral: "Neutrálny",
    statusBlocked: "Blokovaný",
    menuAdd: "Pridať do kontaktov…",
    menuEdit: "Upraviť kontakt…",
    menuMarkTrusted: "Označiť ako dôveryhodného",
    menuMarkNeutral: "Označiť ako neutrálneho",
    menuMarkBlocked: "Blokovať",
    menuCopyKey: "Kopírovať verejný kľúč",
    menuOpen: "Otvoriť v Kontaktoch",
    keyCopied: "Verejný kľúč skopírovaný",
    editTitle: "Upraviť kontakt",
    addTitle: "Pridať kontakt",
    nickLabel: "Prezývka",
    nickPlaceholder: "napr. Alica zo stretnutia",
    noteLabel: "Poznámky",
    notePlaceholder: "Čokoľvek, čo si chcete zapamätať — ako ich kontaktovať, predošlé obchody…",
    save: "Uložiť",
    cancel: "Zrušiť",
    remove: "Odstrániť kontakt",
    removeConfirmTitle: "Odstrániť kontakt?",
    removeConfirmBody: "Týmto sa vymaže vaša lokálna prezývka a poznámky pre {who}. Nedá sa to vrátiť späť.",
    blockedWarning: "Túto protistranu ste zablokovali",
    blockedWarningBody:
      "Túto osobu ste označili ako blokovanú. Blokovanie je len osobná pripomienka — obchod nezastaví. Pokračujte iba vtedy, ak to naozaj chcete.",
  },
  status: {
  ...
  coins: {
    ...
    connRpcLocal: "RPC (lokálne)",
    connRpcRemote: "RPC (vzdialené)",
    connElectrumLocal: "Electrum (lokálne)",
    connElectrumRemote: "Electrum (vzdialené)",
    connRpcTip:
  ...
  wallets: {
    ...
    receiveIntroRpc:
      "Čerstvá adresa z peňaženky vášho uzla. Mince sem poslané sa po potvrdení objavia v zostatku.",
    receiveFreshNote:
  ...
  narrate: {
    finalizing: "Nárokovali ste si svoje {got} — finálne potvrdenia. Nechajte aplikáciu otvorenú, kým sa nezahrabe; vaše {gave} zostávajú dovtedy chránené.",
    initiating:
    ...
    signedTaker:
      "Obe strany podpísali. Hneď ako sa ich {a} potvrdia, váš démon zamkne vaše {b} a potom automaticky nárokuje {a}. Hneď ako sú vaše {b} uzamknuté, vrátia sa o {t2}, ak sa čokoľvek zasekne.",
    fundedAMaker:
  ...
  progress: {
    ...
    securing: "Zabezpečujem vaše {coin}",
    funding: "Uzamykanie vašich {coin} — ak to viazne, odomknite peňaženku",
    blocks: "+{n} blokov",
