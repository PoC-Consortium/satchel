...
export const cs: Bundle = {
  ...
  settings: {
    ...
    protocolsHint:
      "Co tato sestava umí — čísla jsou verze formátu zpráv každého protokolu (nejde o pořadí protokolů). Nabídky s jinou verzí lze prohlížet, ale ne přijmout; obě strany swapu se musí shodovat.",
    machine: "Tento stroj",
    machineHint:
  ...
  exit: {
    ...
    handoffFailed:
      "Engine se nepodařilo předat do běhu na pozadí: {err}. Satchel zůstává otevřený a engine dál hlídá vaše swapy — opravte problém a zkuste to znovu.",
  },
  unlock: {
