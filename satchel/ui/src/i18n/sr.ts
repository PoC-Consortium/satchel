...
export const sr: Bundle = {
  ...
  serverSync: {
    ...
    promptTitle: "Нови препоручени Electrum сервери",
    promptBody:
      "Доступни су ажурирани подразумевани Electrum сервери. Њихово додавање побољшава поузданост — ваши постојећи сервери се задржавају.",
