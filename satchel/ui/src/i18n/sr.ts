...
export const sr: Bundle = {
  ...
  settings: {
    ...
    protocolsHint:
      "Шта ова верзија говори — бројеви су верзија формата порука сваког протокола (не рангирају протоколе). Понуде са другом верзијом могу се прегледати, али не и прихватити; обе стране свопа морају да се подударају.",
    machine: "Ова машина",
    machineHint:
  ...
  swaps: {
    ...
    takeoverPrefundNote:
      "Свопови у којима још ништа није закључано настављају се само ако овај новчаник може да потврди да је њихово финансирање безбедно за слање; у супротном се неколико минута након преузимања завршавају чистим прекидом. Ни у једном случају средства нису угрожена.",
  ...
  progress: {
    ...
    awaitingOurLock: "Чекање на ваше закључавање",
