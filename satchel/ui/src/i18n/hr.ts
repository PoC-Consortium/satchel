...
export const hr: Bundle = {
  ...
  header: {
    ...
    coinOk: "{name} — povezano · {via} · vrh {tip}",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} od {total} Electrum poslužitelja je nedostupno — pričuvni poslužitelji pokrivaju.",
    intro:
    ...
    sendOverBalance: "Više od raspoloživog stanja (uključujući procijenjenu naknadu).",
    feeLabel: "Mrežna naknada — dodaje se povrh iznosa",
    fee_slow: "Sporo",
    fee_normal: "Normalno",
    fee_fast: "Brzo",
    fee_custom: "Prilagođeno",
    feeRate: "{rate} sat/vB",
    feeNoEstimate: "nema podataka",
    feeNoEstimatesNote: "Trenutno nema procjena naknada uživo — tržište naknada možda je prazno. Postavite prilagođenu stopu.",
    feeCustomLabel: "Prilagođena stopa (sat/vB)",
    feeCustomMin: "Najmanje {min} sat/vB.",
    sendFeePreview: "Procijenjena mrežna naknada: ~{fee} {sym} za tipičnu transakciju.",
    sendReview: "Pregled",
    sendBack: "Natrag",
    sendConfirmTitle: "Potvrdite slanje ({sym})",
    sendConfirmRecipient: "Primatelj",
    sendConfirmAmount: "Iznos",
    sendConfirmFee: "Mrežna naknada (procijenjena)",
    sendConfirmFeeValue: "~{fee} {sym} ({rate} sat/vB)",
    sendConfirmTotal: "Ukupno (približno)",
    sendIrreversible: "Transakcije su nepovratne. Dobro provjerite adresu — kovanice poslane na pogrešnu adresu zauvijek su izgubljene.",
    ...
    bump: "Ubrzaj",
    bumpHint: "Platite višu naknadu kako bi se ova transakcija na čekanju prije potvrdila (RBF).",
    bumpTitle: "Povisi naknadu ({sym})",
    bumpIntro: "Zamijenite ovu transakciju na čekanju novom koja plaća višu naknadu (RBF). Trenutno plaća ~{rate} sat/vB.",
    bumpNeedHigher: "Odaberite stopu iznad trenutne od ~{rate} sat/vB.",
    bumpBroadcast: "Naknada povišena — zamjenska {txid}… je na putu ({sym}).",
    bumpConfirm: "Povisi naknadu",
  },
  corkboard: {
  ...
  relays: {
    title: "Mreža",
    tabNostr: "Nostr",
    serversSubtitle: "Electrum poslužitelji za {coin} — poslužitelj novčanika, aktivni pogledi i hladne pričuve. Stanje se prati samo iz stvarnog prometa; pričuvni poslužitelji se ne kontaktiraju dok ne budu promaknuti.",
    healthyCount: "{healthy} / {total} zdravo",
    roleWallet: "novčanik",
    roleView: "pogled",
    roleStandby: "pričuva",
    stateHealthy: "zdrav",
    stateDown: "nedostupan",
    stateUntested: "netestiran",
    retryIn: "novi pokušaj za {secs} s",
    serverTip: "{requests} zahtjeva · {failures} grešaka",
    serverErr: "zadnja greška: {error}",
    noServers: "Ovaj novčić nema konfigurirane Electrum poslužitelje.",
  ...
  revive: {
    title: "Vratiti vaše ponude?",
    intro: "Ove su ponude skinute s ploče pri zatvaranju aplikacije. Cijene su možda zastarjele — oživite ih da ih ponovno objavite kao svježe ponude pod istim uvjetima, ili ih odbacite pa ostaju povučene.",
    timelocks: "vremenske brave {t1} h/{t2} h",
    reviveAll: "Oživi sve",
    revive: "Oživi",
    dismiss: "Odbaci",
    close: "Zatvori",
  ...
  log: {
    takeoverRefundOnly: "preuzimanje {id}: novčanik isplate nije na ovom stroju — zasad samo povrat; priključite vlasnički novčanik za dovršetak swapa",
    title: "Aktivnost",
    ...
    connected: "povezano s pactd {version}",
    ...
    offerRevived: "ponuda {old} oživljena kao svježa ponuda {id}",
    reviveError: "oživljavanje ponude {id}: {err}",
    offerDismissed: "ponuda {id} odbačena — ostaje povučena",
    offerDismissedDeadPair: "ponuda {id} odbačena — njezin par više nije postavljen",
    dismissError: "odbacivanje ponude {id}: {err}",
  ...
  narrate: {
    locking: "Zaključavamo vaše {coin} — transakcija zaključavanja upravo izlazi. Odsad vas štite timelockovi; otkazivanje više nije sigurnosna mreža.",
    awaitingOurLock: "Sljedeća zaključava vaša strana {coin} — šalje je stroj koji vodi ovaj swap.",
