...
export const ptBR: Bundle = {
  ...
  header: {
    ...
    coinOk: "{name} — conectada · {via} · topo {tip}",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} de {total} servidores Electrum fora do ar — os servidores de backup estão cobrindo.",
    intro:
    ...
    sendOverBalance: "Mais do que o saldo disponível para gastar (incluindo a taxa estimada).",
    feeLabel: "Taxa de rede — somada à quantia",
    fee_slow: "Lenta",
    fee_normal: "Normal",
    fee_fast: "Rápida",
    fee_custom: "Personalizada",
    feeRate: "{rate} sat/vB",
    feeNoEstimate: "sem dados",
    feeNoEstimatesNote: "Sem estimativas de taxa ao vivo no momento — o mercado de taxas pode estar vazio. Defina uma taxa personalizada.",
    feeCustomLabel: "Taxa personalizada (sat/vB)",
    feeCustomMin: "Mínimo de {min} sat/vB.",
    sendFeePreview: "Taxa de rede estimada: ~{fee} {sym} para uma transação típica.",
    sendReview: "Revisar",
    sendBack: "Voltar",
    sendConfirmTitle: "Confirmar envio ({sym})",
    sendConfirmRecipient: "Destinatário",
    sendConfirmAmount: "Quantia",
    sendConfirmFee: "Taxa de rede (estimada)",
    sendConfirmFeeValue: "~{fee} {sym} ({rate} sat/vB)",
    sendConfirmTotal: "Total (aprox.)",
    sendIrreversible: "Transações são irreversíveis. Confira bem o endereço — moedas enviadas para um endereço errado estão perdidas.",
    ...
    bump: "Aumentar",
    bumpHint: "Pague uma taxa maior para esta transação pendente confirmar mais cedo (RBF).",
    bumpTitle: "Aumentar a taxa ({sym})",
    bumpIntro: "Substitua esta transação pendente por uma que pague uma taxa maior (RBF). Ela paga ~{rate} sat/vB agora.",
    bumpNeedHigher: "Escolha uma taxa acima dos ~{rate} sat/vB atuais.",
    bumpBroadcast: "Taxa aumentada — a substituta {txid}… está a caminho ({sym}).",
    bumpConfirm: "Aumentar taxa",
  },
  corkboard: {
  ...
  relays: {
    title: "Rede",
    tabNostr: "Nostr",
    serversSubtitle: "Servidores Electrum de {coin} — o servidor da carteira, as visões ativas e as reservas frias. A saúde é observada apenas do tráfego real; servidores em espera nunca são contatados até serem promovidos.",
    healthyCount: "{healthy} / {total} saudáveis",
    roleWallet: "carteira",
    roleView: "visão",
    roleStandby: "reserva",
    stateHealthy: "saudável",
    stateDown: "fora do ar",
    stateUntested: "não testado",
    retryIn: "nova tentativa em {secs}s",
    serverTip: "{requests} requisições · {failures} falhas",
    serverErr: "último erro: {error}",
    noServers: "Esta moeda não tem servidores Electrum configurados.",
  ...
  revive: {
    title: "Republicar suas ofertas?",
    intro: "Estas ofertas foram retiradas do quadro quando o app foi fechado. Os preços podem estar desatualizados — reviva-as para republicá-las como ofertas novas com os mesmos termos, ou dispense-as para que permaneçam retiradas.",
    timelocks: "timelocks {t1}h/{t2}h",
    reviveAll: "Reviver todas",
    revive: "Reviver",
    dismiss: "Dispensar",
    close: "Fechar",
  },
  ...
  log: {
    takeoverRefundOnly: "assumir {id}: a carteira de pagamento não está nesta máquina — por enquanto apenas reembolso; conecte a carteira proprietária para concluir o swap",
    title: "Atividade",
    ...
    connected: "conectado ao pactd {version}",
    ...
    reviveError: "reviver oferta {id}: {err}",
    offerDismissed: "oferta {id} dispensada — permanece retirada",
    offerDismissedDeadPair: "oferta {id} dispensada — seu par não está mais configurado",
    dismissError: "dispensar oferta {id}: {err}",
  ...
  narrate: {
    locking: "Bloqueando seus {coin} — a transação de bloqueio está saindo agora. Daqui em diante os timelocks protegem você; cancelar não é mais a rede de segurança.",
    awaitingOurLock: "Seu lado bloqueia {coin} em seguida — a máquina que conduz este swap envia.",
  ...
  exit: {
    ...
    handoffFailed:
      "Não foi possível deixar o motor rodando em segundo plano: {err}. O Satchel continua aberto e o motor segue vigiando suas trocas — corrija o problema e tente novamente.",
  },
  unlock: {
