...
export const de: Bundle = {
  ...
  header: {
    ...
    coinOk: "{name} — verbunden · {via} · Tip {tip}",
  ...
  contacts: {
    title: "Kontakte",
    subtitle: "Deine privaten Spitznamen für die Leute, mit denen du handelst.",
    privacyNote:
      "Kontakte werden nur auf diesem Gerät gespeichert und niemals geteilt, veröffentlicht oder an ein Relay gesendet. Ein Spitzname ist deine Bezeichnung — Identicon und Fingerabdruck bleiben die echte Identität.",
    searchPlaceholder: "Spitzname, Notiz oder Schlüssel suchen",
    empty: "Noch keine Kontakte. Klicke irgendwo auf das Identicon einer Gegenpartei, um einen hinzuzufügen.",
    emptyFiltered: "Keine Kontakte passen zu diesem Filter.",
    count: "{n} Kontakte",
    colWho: "Identität",
    colNick: "Spitzname",
    colNote: "Notizen",
    ...
    colActions: "",
    filterAll: "Alle",
    filterTrusted: "Vertraut",
    filterBlocked: "Blockiert",
    // Corkboard toggle: drop blocked makers' offers from the ladder.
    hideBlocked: "Blockierte Angebote ausblenden",
    statusTrusted: "Vertraut",
    statusNeutral: "Neutral",
    statusBlocked: "Blockiert",
    menuAdd: "Zu Kontakten hinzufügen…",
    menuEdit: "Kontakt bearbeiten…",
    menuMarkTrusted: "Als vertraut markieren",
    menuMarkNeutral: "Als neutral markieren",
    menuMarkBlocked: "Blockieren",
    menuCopyKey: "Öffentlichen Schlüssel kopieren",
    menuOpen: "In Kontakten öffnen",
    keyCopied: "Öffentlicher Schlüssel kopiert",
    editTitle: "Kontakt bearbeiten",
    addTitle: "Kontakt hinzufügen",
    nickLabel: "Spitzname",
    nickPlaceholder: "z. B. Alice vom Meetup",
    noteLabel: "Notizen",
    notePlaceholder: "Alles, woran du dich erinnern willst — wie du sie erreichst, vergangene Trades…",
    save: "Speichern",
    cancel: "Abbrechen",
    remove: "Kontakt entfernen",
    removeConfirmTitle: "Kontakt entfernen?",
    removeConfirmBody: "Dies löscht deinen lokalen Spitznamen und die Notizen für {who}. Es kann nicht rückgängig gemacht werden.",
    blockedWarning: "Du hast diese Gegenpartei blockiert",
    blockedWarningBody:
      "Du hast diese Person als blockiert markiert. Das Blockieren ist nur eine persönliche Erinnerung — es stoppt den Handel nicht. Fahre nur fort, wenn du es wirklich willst.",
  },
  status: {
  ...
  coins: {
    ...
    switchHidesTitle: "Das blendet deine Pact-Seed-Wallet aus",
    switchHidesBody:
      "Deine Pact-Seed-Wallet auf diesem Coin hält noch {balance} {sym}. Beim Wechsel zu einer Node-Verbindung wird sie ausgeblendet — die Coins bleiben sicher auf deinem Seed und tauchen sofort wieder auf, sobald du zurück zu Electrum wechselst, aber bis dahin werden sie weder angezeigt noch finanzieren sie Swaps. Überlege, sie vorher woandershin zu senden.",
    switchHidesConfirm: "Trotzdem wechseln",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} von {total} Electrum-Servern sind ausgefallen — Backup-Server übernehmen.",
    intro:
    ...
    sendOverBalance: "Mehr als das verfügbare Guthaben (inklusive der geschätzten Gebühr).",
    feeLabel: "Netzwerkgebühr — kommt zum Betrag dazu",
    fee_slow: "Langsam",
    fee_normal: "Normal",
    fee_fast: "Schnell",
    fee_custom: "Eigene",
    feeRate: "{rate} sat/vB",
    feeNoEstimate: "keine Daten",
    feeNoEstimatesNote:
      "Gerade keine Live-Gebührenschätzungen — der Gebührenmarkt ist womöglich leer. Setze eine eigene Rate.",
    feeCustomLabel: "Eigene Rate (sat/vB)",
    feeCustomMin: "Mindestens {min} sat/vB.",
    sendFeePreview: "Geschätzte Netzwerkgebühr: ~{fee} {sym} für eine typische Transaktion.",
    sendReview: "Prüfen",
    sendBack: "Zurück",
    sendConfirmTitle: "Senden bestätigen ({sym})",
    sendConfirmRecipient: "Empfänger",
    sendConfirmAmount: "Betrag",
    sendConfirmFee: "Netzwerkgebühr (geschätzt)",
    sendConfirmFeeValue: "~{fee} {sym} ({rate} sat/vB)",
    sendConfirmTotal: "Gesamt (ca.)",
    sendIrreversible:
      "Transaktionen sind unumkehrbar. Prüfe die Adresse doppelt — Coins an eine falsche Adresse sind verloren.",
    ...
    bump: "Anheben",
    bumpHint: "Zahle eine höhere Gebühr, damit diese ausstehende Transaktion schneller bestätigt wird (RBF).",
    bumpTitle: "Gebühr erhöhen ({sym})",
    bumpIntro:
      "Ersetze diese ausstehende Transaktion durch eine mit höherer Gebühr (RBF). Aktuell zahlt sie ~{rate} sat/vB.",
    bumpNeedHigher: "Wähle eine Rate über den aktuellen ~{rate} sat/vB.",
    bumpBroadcast: "Gebühr erhöht — Ersatz {txid}… ist unterwegs ({sym}).",
    bumpConfirm: "Gebühr erhöhen",
  },
  corkboard: {
  ...
  relays: {
    title: "Netzwerk",
    tabNostr: "Nostr",
    serversSubtitle: "Electrum-Server für {coin} — der Wallet-Server, die aktiven Views und kalte Backups. Der Zustand wird nur aus echtem Verkehr beobachtet; Standby-Server werden nie kontaktiert, bis sie befördert werden.",
    healthyCount: "{healthy} / {total} gesund",
    roleWallet: "Wallet",
    roleView: "View",
    roleStandby: "Standby",
    stateHealthy: "gesund",
    stateDown: "ausgefallen",
    stateUntested: "ungetestet",
    retryIn: "erneut in {secs}s",
    serverTip: "{requests} Anfragen · {failures} Fehler",
    serverErr: "letzter Fehler: {error}",
    noServers: "Für diesen Coin sind keine Electrum-Server konfiguriert.",
  ...
  progress: {
    ...
    funding: "Sperre deine {coin} — Wallet entsperren, falls es hängt",
    blocks: "+{n} Blöcke",
