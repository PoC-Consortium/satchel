...
export const es: Bundle = {
  ...
  seed: {
    ...
    reimportBanner:
      "Este equipo ya no puede desbloquear la semilla almacenada — falta la clave del almacén de claves del sistema (la carpeta de datos se movió a un equipo nuevo o se restableció el llavero). Vuelve a introducir tu frase de recuperación para configurarla de nuevo en este equipo. Tus fondos y swaps no se ven afectados.",
  ...
  narrate: {
    locking: "Bloqueando tus {coin} — la transacción de bloqueo está saliendo ahora. Desde aquí te protegen los timelocks; cancelar ya no es la red de seguridad.",
    awaitingOurLock: "Tu lado bloquea {coin} a continuación — la máquina que dirige este swap la envía.",
  ...
  progress: {
    ...
    awaitingOurLock: "Esperando tu bloqueo",
