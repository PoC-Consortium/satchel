...
export const tr: Bundle = {
  ...
  header: {
    ...
    coinOk: "{name} — bağlı · {via} · tepe {tip}",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} / {total} Electrum sunucusu erişilemez durumda — yedek sunucular devrede.",
    intro:
    ...
    sendOverBalance: "Harcanabilir bakiyeden fazla (tahmini ücret dahil).",
    feeLabel: "Ağ ücreti — miktarın üzerine eklenir",
    fee_slow: "Yavaş",
    fee_normal: "Normal",
    fee_fast: "Hızlı",
    fee_custom: "Özel",
    feeRate: "{rate} sat/vB",
    feeNoEstimate: "veri yok",
    feeNoEstimatesNote: "Şu anda canlı ücret tahmini yok — ücret piyasası boş olabilir. Özel bir oran belirleyin.",
    feeCustomLabel: "Özel oran (sat/vB)",
    feeCustomMin: "En az {min} sat/vB.",
    sendFeePreview: "Tahmini ağ ücreti: tipik bir işlem için ~{fee} {sym}.",
    sendReview: "Gözden geçir",
    sendBack: "Geri",
    sendConfirmTitle: "Göndermeyi onayla ({sym})",
    sendConfirmRecipient: "Alıcı",
    sendConfirmAmount: "Miktar",
    sendConfirmFee: "Ağ ücreti (tahmini)",
    sendConfirmFeeValue: "~{fee} {sym} ({rate} sat/vB)",
    sendConfirmTotal: "Toplam (yaklaşık)",
    sendIrreversible: "İşlemler geri alınamaz. Adresi iyice kontrol edin — yanlış adrese gönderilen coinler kaybolur.",
    ...
    bump: "Hızlandır",
    bumpHint: "Bu bekleyen işlemin daha erken onaylanması için daha yüksek ücret ödeyin (RBF).",
    bumpTitle: "Ücreti artır ({sym})",
    bumpIntro: "Bu bekleyen işlemi daha yüksek ücret ödeyen bir işlemle değiştirin (RBF). Şu anda ~{rate} sat/vB ödüyor.",
    bumpNeedHigher: "Mevcut ~{rate} sat/vB üzerinde bir oran seçin.",
    bumpBroadcast: "Ücret artırıldı — yerine geçen {txid}… yolda ({sym}).",
    bumpConfirm: "Ücreti artır",
  },
  corkboard: {
  ...
  relays: {
    title: "Ağ",
    tabNostr: "Nostr",
    serversSubtitle: "{coin} için Electrum sunucuları — cüzdan sunucusu, etkin görünümler ve soğuk yedekler. Sağlık yalnızca gerçek trafikten gözlemlenir; yedek sunucularla terfi edilene dek iletişim kurulmaz.",
    healthyCount: "{healthy} / {total} sağlıklı",
    roleWallet: "cüzdan",
    roleView: "görünüm",
    roleStandby: "yedek",
    stateHealthy: "sağlıklı",
    stateDown: "erişilemiyor",
    stateUntested: "denenmemiş",
    retryIn: "{secs} sn içinde yeniden dene",
    serverTip: "{requests} istek · {failures} hata",
    serverErr: "son hata: {error}",
    noServers: "Bu koin için yapılandırılmış Electrum sunucusu yok.",
