...
export const tr: Bundle = {
  ...
  contacts: {
    title: "Kişiler",
    subtitle: "İşlem yaptığınız kişiler için özel takma adlarınız.",
    privacyNote:
      "Kişiler yalnızca bu cihazda saklanır ve asla paylaşılmaz, yayınlanmaz veya bir röleye gönderilmez. Takma ad sizin etiketinizdir — gerçek kimlik, identicon ve parmak izi olarak kalır.",
    searchPlaceholder: "Takma ad, not veya anahtar ara",
    empty: "Henüz kişi yok. Eklemek için herhangi bir yerde bir karşı tarafın identicon'una tıklayın.",
    emptyFiltered: "Bu filtreyle eşleşen kişi yok.",
    count: "{n} kişi",
    colWho: "Kimlik",
    colNick: "Takma ad",
    colNote: "Notlar",
    ...
    colActions: "",
    filterAll: "Tümü",
    filterTrusted: "Güvenilir",
    filterBlocked: "Engellenmiş",
    // Corkboard toggle: drop blocked makers' offers from the ladder.
    hideBlocked: "Engellenen teklifleri gizle",
    statusTrusted: "Güvenilir",
    statusNeutral: "Nötr",
    statusBlocked: "Engellenmiş",
    menuAdd: "Kişilere ekle…",
    menuEdit: "Kişiyi düzenle…",
    menuMarkTrusted: "Güvenilir olarak işaretle",
    menuMarkNeutral: "Nötr olarak işaretle",
    menuMarkBlocked: "Engelle",
    menuCopyKey: "Açık anahtarı kopyala",
    menuOpen: "Kişiler'de aç",
    keyCopied: "Açık anahtar kopyalandı",
    editTitle: "Kişiyi düzenle",
    addTitle: "Kişi ekle",
    nickLabel: "Takma ad",
    nickPlaceholder: "örn. buluşmadan Alice",
    noteLabel: "Notlar",
    notePlaceholder: "Hatırlamak istediğiniz her şey — onlara nasıl ulaşılır, geçmiş işlemler…",
    save: "Kaydet",
    cancel: "İptal",
    remove: "Kişiyi kaldır",
    removeConfirmTitle: "Kişi kaldırılsın mı?",
    removeConfirmBody: "Bu, {who} için yerel takma adınızı ve notlarınızı siler. Geri alınamaz.",
    blockedWarning: "Bu karşı tarafı engellediniz",
    blockedWarningBody:
      "Bu kişiyi engellenmiş olarak işaretlediniz. Engelleme yalnızca kişisel bir hatırlatmadır — işlemi durdurmaz. Yalnızca gerçekten istiyorsanız devam edin.",
  },
  status: {
  ...
  progress: {
    ...
    funding: "{coin} kilitleniyor — takılırsa cüzdanın kilidini açın",
    blocks: "+{n} blok",
