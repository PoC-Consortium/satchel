...
export const fr: Bundle = {
  ...
  makeOffer: {
    ...
    validForTitle: "Valable pendant",
    ttl1h: "1 h",
    ttl4h: "4 h",
    ttl8h: "8 h",
    ttl24h: "24 h",
    ttl1w: "1 semaine",
    ttlCustom: "Personnalisé",
  ...
  header: {
    ...
    coinOk: "{name} — connecté · {via} · tip {tip}",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} des {total} serveurs Electrum sont hors service — les serveurs de secours prennent le relais.",
    intro:
  ...
  relays: {
    title: "Réseau",
    tabNostr: "Nostr",
    serversSubtitle: "Serveurs Electrum pour {coin} — le serveur du portefeuille, les vues actives et les réserves froides. L'état est observé uniquement à partir du trafic réel ; les serveurs en réserve ne sont jamais contactés avant leur promotion.",
    healthyCount: "{healthy} / {total} sains",
    roleWallet: "portefeuille",
    roleView: "vue",
    roleStandby: "réserve",
    stateHealthy: "sain",
    stateDown: "hors service",
    stateUntested: "non testé",
    retryIn: "réessai dans {secs}s",
    serverTip: "{requests} requêtes · {failures} échecs",
    serverErr: "dernière erreur : {error}",
    noServers: "Aucun serveur Electrum configuré pour cette pièce.",
  ...
  funds: {
    checking: "Vérification des fonds…",
    insufficient:
  ...
  narrate: {
    locking: "Verrouillage de vos {coin} — la transaction de verrouillage part maintenant. Les timelocks vous protègent désormais ; annuler n'est plus le filet de sécurité.",
    awaitingOurLock: "Votre côté verrouille {coin} ensuite — la machine qui pilote ce swap l'envoie.",
  ...
  progress: {
    ...
    awaitingOurLock: "En attente de votre verrouillage",
  ...
  exit: {
    ...
    handoffFailed:
      "Impossible de laisser le moteur tourner en arrière-plan : {err}. Satchel reste ouvert et le moteur continue de surveiller vos échanges — corrigez le problème et réessayez.",
  },
  unlock: {
