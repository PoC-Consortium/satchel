...
export const hi: Bundle = {
  ...
  serverSync: {
    ...
    promptTitle: "नए अनुशंसित Electrum सर्वर",
    promptBody:
      "अपडेट किए गए डिफ़ॉल्ट Electrum सर्वर उपलब्ध हैं। उन्हें जोड़ने से विश्वसनीयता बेहतर होती है — आपके मौजूदा सर्वर बने रहते हैं।",
    coinLine: "{coin} — {count} नए",
    add: "सर्वर जोड़ें",
    ignore: "अनदेखा करें",
  },
};
