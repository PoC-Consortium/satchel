...
export const hi: Bundle = {
  ...
  seed: {
    ...
    reimportBanner:
      "यह मशीन संग्रहीत seed को अब अनलॉक नहीं कर सकती — सिस्टम keystore की कुंजी गायब है (डेटा फ़ोल्डर किसी नई मशीन पर ले जाया गया या keychain रीसेट हो गया)। इस मशीन पर फिर से सेट करने के लिए अपना recovery phrase दोबारा दर्ज करें। आपके फंड और swaps प्रभावित नहीं होते।",
    wordCount: "{n} शब्द",
    wordCountHint:
  ...
  settings: {
    ...
    feeMaxHint:
      "funding fee bump के लिए सीमा (HTLC + adaptor); डिफ़ॉल्ट 500, जो सिस्टम की कठोर अधिकतम सीमा भी है। लागत सीमित करने के लिए इसे कम करें। redeem और refund bump इसे अनदेखा करते हैं — timelock के पास वे जो भी ज़रूरी हो चुकाते हैं, दांव पर लगे मूल्य तक, ताकि किसी fee सीमा के कारण कोई leg कभी न खोए।",
    feeReservation: "Funding bump आरक्षण (×)",
    feeReservationHint:
      "केवल funding bump (HTLC + adaptor)। funds चेक bump हेडरूम के रूप में जितना बैलेंस अलग रखता है, और साथ ही funding bump की सीमा (उसकी मूल feerate का यह गुणक)। अधिक बड़े fee स्पाइक से बचाता है पर अधिक बैलेंस बाँधता है और अधिक स्वैप अस्वीकार करता है। डिफ़ॉल्ट 3।",
    feeSave: "सहेजें",
    ...
    protocolsHint:
      "यह बिल्ड क्या बोलता है — संख्याएँ हर प्रोटोकॉल के संदेश-प्रारूप का संस्करण हैं (वे प्रोटोकॉल की रैंकिंग नहीं हैं)। अलग संस्करण वाले ऑफ़र देखे जा सकते हैं पर लिए नहीं जा सकते; स्वैप के दोनों पक्षों का मेल ज़रूरी है।",
    machine: "यह मशीन",
    machineHint:
      "इस इंस्टॉल की id। यदि आप एक ही seed को एक से अधिक मशीनों पर चलाते हैं, तो हर मशीन अपने खुद के स्वैप चलाती है — बाकी swap dock में केवल-पढ़ने के रूप में “दूसरी मशीन” के रूप में दिखती हैं, और यदि कोई रुक जाए तो आप उन्हें यहाँ अपने नियंत्रण में ले सकते हैं। बहु-मशीन उपयोग failover और रिकवरी के लिए है, दो मशीनों से एक साथ व्यापार करने के लिए नहीं (वे एक ही बैलेंस साझा करती हैं)।",
  ...
  swaps: {
    ...
    foreignGroup: "दूसरी मशीन · {machine}",
    takeover: "नियंत्रण लें",
    takeoverHint:
      "इस मशीन के स्वैप यहाँ चलाना शुरू करें। यह तभी करें जब वह मशीन रुक चुकी हो।",
    takeoverTitle: "{machine} के स्वैप का नियंत्रण लें?",
    takeoverBody:
      "केवल तभी जब {machine} रुक चुकी हो। यह मशीन उसके सभी चालू स्वैप चलाना शुरू कर देगी। यदि दोनों मशीनें एक ही स्वैप को एक साथ चलाती हैं, तो वे आपके funds का दोहरा-खर्च कर सकती हैं और पैसा खो सकती हैं।",
    takeoverPrefundNote:
      "जिन स्वैप में अभी कुछ लॉक नहीं हुआ है, वे तभी आगे बढ़ते हैं जब यह वॉलेट पुष्टि कर सके कि उनकी फंडिंग भेजना सुरक्षित है; अन्यथा टेकओवर के कुछ मिनट बाद वे साफ़ तरीके से रद्द हो जाते हैं। दोनों ही स्थितियों में कोई धनराशि जोखिम में नहीं है।",
    takeoverConfirm: "वह मशीन रुक चुकी है — नियंत्रण लें",
    takeoverCancel: "रद्द करें",
    col: {
      swap: "स्वैप",
      role: "भूमिका",
      state: "स्थिति",
  ...
  exit: {
    ...
    handoffFailed:
      "इंजन को पृष्ठभूमि में चलते रहने के लिए सौंपा नहीं जा सका: {err}. Satchel खुला रहता है और इंजन आपके स्वैप पर नज़र रखता रहता है — समस्या ठीक करें और फिर से प्रयास करें।",
  },
  unlock: {
  ...
  serverSync: {
    ...
    resetConfirm:
      "इस coin के Electrum सर्वरों को शिप किए गए डिफ़ॉल्ट से बदलें? सूची में आपके द्वारा किए गए कोई भी बदलाव खारिज कर दिए जाएँगे।",
  },
};
