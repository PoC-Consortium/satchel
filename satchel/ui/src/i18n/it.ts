...
export const it: Bundle = {
  ...
  header: {
    ...
    coinOk: "{name} — connesso · {via} · tip {tip}",
  ...
  coins: {
    ...
    switchHidesTitle: "Questo nasconde il tuo wallet del seed Pact",
    switchHidesBody:
      "Il tuo wallet del seed Pact su questa coin contiene ancora {balance} {sym}. Passare a una connessione al nodo lo nasconde — le coin restano al sicuro sul tuo seed e ricompaiono appena torni a Electrum, ma fino ad allora non compariranno e non finanzieranno swap. Valuta di inviarle altrove prima.",
    switchHidesConfirm: "Cambia comunque",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} di {total} server Electrum offline — i server di riserva coprono.",
    intro:
    ...
    sendOverBalance: "Più del saldo spendibile (inclusa la commissione stimata).",
    feeLabel: "Commissione di rete — si aggiunge all'importo",
    fee_slow: "Lenta",
    fee_normal: "Normale",
    fee_fast: "Veloce",
    fee_custom: "Personalizzata",
    feeRate: "{rate} sat/vB",
    feeNoEstimate: "nessun dato",
    feeNoEstimatesNote: "Al momento non ci sono stime delle commissioni in tempo reale — il mercato delle commissioni potrebbe essere vuoto. Imposta una tariffa personalizzata.",
    feeCustomLabel: "Tariffa personalizzata (sat/vB)",
    feeCustomMin: "Minimo {min} sat/vB.",
    sendFeePreview: "Commissione di rete stimata: ~{fee} {sym} per una transazione tipica.",
    sendReview: "Rivedi",
    sendBack: "Indietro",
    sendConfirmTitle: "Conferma invio ({sym})",
    sendConfirmRecipient: "Destinatario",
    sendConfirmAmount: "Importo",
    sendConfirmFee: "Commissione di rete (stimata)",
    sendConfirmFeeValue: "~{fee} {sym} ({rate} sat/vB)",
    sendConfirmTotal: "Totale (circa)",
    sendIrreversible: "Le transazioni sono irreversibili. Ricontrolla bene l'indirizzo — le coin inviate a uno sbagliato sono perse per sempre.",
    ...
    bump: "Accelera",
    bumpHint: "Paga una commissione più alta perché questa transazione in attesa si confermi prima (RBF).",
    bumpTitle: "Aumenta la commissione ({sym})",
    bumpIntro: "Sostituisci questa transazione in attesa con una che paga una commissione più alta (RBF). Ora paga ~{rate} sat/vB.",
    bumpNeedHigher: "Scegli una tariffa superiore all'attuale ~{rate} sat/vB.",
    bumpBroadcast: "Commissione aumentata — la sostituta {txid}… è in viaggio ({sym}).",
    bumpConfirm: "Aumenta la commissione",
  },
  corkboard: {
  ...
  relays: {
    title: "Rete",
    tabNostr: "Nostr",
    serversSubtitle: "Server Electrum per {coin} — il server del portafoglio, le viste attive e le riserve fredde. Lo stato è osservato solo dal traffico reale; i server di riserva non vengono mai contattati finché non promossi.",
    healthyCount: "{healthy} / {total} sani",
    roleWallet: "portafoglio",
    roleView: "vista",
    roleStandby: "riserva",
    stateHealthy: "sano",
    stateDown: "offline",
    stateUntested: "non testato",
    retryIn: "riprova tra {secs}s",
    serverTip: "{requests} richieste · {failures} errori",
    serverErr: "ultimo errore: {error}",
    noServers: "Questa moneta non ha server Electrum configurati.",
  ...
  swaps: {
    ...
    foreignGroup: "Un'altra macchina · {machine}",
    takeover: "Rileva",
    takeoverHint:
      "Inizia a gestire qui gli swap di questa macchina. Fallo solo una volta che quella macchina è ferma.",
  ...
  narrate: {
    locking: "Blocco dei tuoi {coin} — la transazione di blocco sta partendo ora. Da qui ti proteggono i timelock; annullare non è più la rete di sicurezza.",
    awaitingOurLock: "Il tuo lato blocca {coin} come prossimo passo — la invia la macchina che guida questo swap.",
  ...
  progress: {
    ...
    awaitingOurLock: "In attesa del tuo blocco",
  ...
  exit: {
    ...
    handoffFailed:
      "Impossibile lasciare il motore in esecuzione in background: {err}. Satchel resta aperto e il motore continua a sorvegliare i tuoi scambi — risolvi il problema e riprova.",
  },
  unlock: {
