...
export const it: Bundle = {
  ...
  contacts: {
    title: "Contatti",
    subtitle: "I tuoi soprannomi privati per le persone con cui fai trading.",
    privacyNote:
      "I contatti sono memorizzati solo su questo dispositivo e non vengono mai condivisi, pubblicati o inviati a un relay. Un soprannome è la tua etichetta — l'identicon e l'impronta restano l'identità reale.",
    searchPlaceholder: "Cerca soprannome, nota o chiave",
    empty: "Ancora nessun contatto. Clicca sull'identicon di una controparte ovunque per aggiungerne uno.",
    emptyFiltered: "Nessun contatto corrisponde a questo filtro.",
    count: "{n} contatti",
    colWho: "Identità",
    colNick: "Soprannome",
    colNote: "Note",
    ...
    colActions: "",
    filterAll: "Tutti",
    filterTrusted: "Fidati",
    filterBlocked: "Bloccati",
    // Corkboard toggle: drop blocked makers' offers from the ladder.
    hideBlocked: "Nascondi le offerte bloccate",
    statusTrusted: "Fidato",
    statusNeutral: "Neutrale",
    statusBlocked: "Bloccato",
    menuAdd: "Aggiungi ai contatti…",
    menuEdit: "Modifica contatto…",
    menuMarkTrusted: "Segna come fidato",
    menuMarkNeutral: "Segna come neutrale",
    menuMarkBlocked: "Blocca",
    menuCopyKey: "Copia chiave pubblica",
    menuOpen: "Apri nei Contatti",
    keyCopied: "Chiave pubblica copiata",
    editTitle: "Modifica contatto",
    addTitle: "Aggiungi contatto",
    nickLabel: "Soprannome",
    nickPlaceholder: "es. Alice del meetup",
    noteLabel: "Note",
    notePlaceholder: "Qualsiasi cosa tu voglia ricordare — come contattarli, scambi passati…",
    save: "Salva",
    cancel: "Annulla",
    remove: "Rimuovi contatto",
    removeConfirmTitle: "Rimuovere il contatto?",
    removeConfirmBody: "Questo elimina il tuo soprannome locale e le note per {who}. Non può essere annullato.",
    blockedWarning: "Hai bloccato questa controparte",
    blockedWarningBody:
      "Hai segnato questa persona come bloccata. Il blocco è solo un promemoria personale — non interrompe lo scambio. Continua solo se è ciò che intendi.",
  },
  status: {
  ...
  progress: {
    ...
    ourLock: "Conferma del tuo blocco",
    securing: "Protezione dei tuoi {coin}",
    funding: "Blocco dei tuoi {coin} — sblocca il wallet se si blocca",
    blocks: "+{n} blocchi",
