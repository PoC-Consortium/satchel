...
export const lt: Bundle = {
  ...
  header: {
    ...
    coinOk: "{name} — prijungta · {via} · viršūnė {tip}",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} iš {total} Electrum serverių nepasiekiami — dengia atsarginiai serveriai.",
    intro:
    ...
    sendOverBalance: "Daugiau nei išleidžiamas likutis (įskaitant numatomą mokestį).",
    feeLabel: "Tinklo mokestis — pridedamas prie sumos",
    fee_slow: "Lėtas",
    fee_normal: "Įprastas",
    fee_fast: "Greitas",
    fee_custom: "Pasirinktinis",
    feeRate: "{rate} sat/vB",
    feeNoEstimate: "nėra duomenų",
    feeNoEstimatesNote: "Šiuo metu nėra tiesioginių mokesčių įverčių — mokesčių rinka gali būti tuščia. Nustatykite pasirinktinį tarifą.",
    feeCustomLabel: "Pasirinktinis tarifas (sat/vB)",
    feeCustomMin: "Mažiausiai {min} sat/vB.",
    sendFeePreview: "Numatomas tinklo mokestis: ~{fee} {sym} už įprastą transakciją.",
    sendReview: "Peržiūrėti",
    sendBack: "Atgal",
    sendConfirmTitle: "Patvirtinkite siuntimą ({sym})",
    sendConfirmRecipient: "Gavėjas",
    sendConfirmAmount: "Suma",
    sendConfirmFee: "Tinklo mokestis (numatomas)",
    sendConfirmFeeValue: "~{fee} {sym} ({rate} sat/vB)",
    sendConfirmTotal: "Iš viso (apytiksliai)",
    sendIrreversible: "Transakcijos yra negrįžtamos. Atidžiai patikrinkite adresą — į klaidingą adresą išsiųstos monetos prarandamos visam laikui.",
    ...
    bump: "Padidinti",
    bumpHint: "Sumokėkite didesnį mokestį, kad ši laukianti transakcija būtų patvirtinta greičiau (RBF).",
    bumpTitle: "Padidinti mokestį ({sym})",
    bumpIntro: "Pakeiskite šią laukiančią transakciją kita, mokančia didesnį mokestį (RBF). Dabar ji moka ~{rate} sat/vB.",
    bumpNeedHigher: "Pasirinkite tarifą, didesnį nei dabartinis ~{rate} sat/vB.",
    bumpBroadcast: "Mokestis padidintas — pakaitinė {txid}… jau kelyje ({sym}).",
    bumpConfirm: "Padidinti mokestį",
  },
  corkboard: {
  ...
  relays: {
    title: "Tinklas",
    tabNostr: "Nostr",
    serversSubtitle: "{coin} Electrum serveriai — piniginės serveris, aktyvūs vaizdai ir šaltos atsargos. Būsena stebima tik iš tikro srauto; atsarginiai serveriai nekontaktuojami, kol nepaaukštinami.",
    healthyCount: "{healthy} / {total} sveiki",
    roleWallet: "piniginė",
    roleView: "vaizdas",
    roleStandby: "atsarga",
    stateHealthy: "sveikas",
    stateDown: "nepasiekiamas",
    stateUntested: "netikrintas",
    retryIn: "bandymas po {secs} s",
    serverTip: "{requests} užklausų · {failures} klaidų",
    serverErr: "paskutinė klaida: {error}",
    noServers: "Ši moneta neturi sukonfigūruotų Electrum serverių.",
  ...
  narrate: {
    locking: "Užrakiname jūsų {coin} — užrakto transakcija siunčiama dabar. Nuo šiol jus saugo timelock'ai; atšaukimas nebėra apsaugos tinklas.",
    awaitingOurLock: "Toliau jūsų pusė užrakina {coin} — ją išsiųs šiuos mainus valdantis įrenginys.",
