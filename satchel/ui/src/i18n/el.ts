...
export const el: Bundle = {
  ...
  settings: {
    ...
    feeCommittedHint:
      "Πόσο επιπλέον προπληρώνεται το τέλος εξαργύρωσης v2 ώστε να επιβεβαιωθεί ακόμα και όταν το Satchel είναι κλειστό. Ισχύει μόνο για νέες ανταλλαγές. Προεπιλογή 1.",
    feeSave: "Αποθήκευση",
