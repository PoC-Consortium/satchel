...
export const el: Bundle = {
  ...
  settings: {
    ...
    protocolsHint:
      "Τι μιλά αυτή η έκδοση — οι αριθμοί είναι η έκδοση μορφής μηνυμάτων κάθε πρωτοκόλλου (δεν κατατάσσουν τα πρωτόκολλα). Προσφορές με άλλη έκδοση μπορούν να προβληθούν αλλά όχι να ληφθούν· οι δύο πλευρές ενός swap πρέπει να ταιριάζουν.",
  ...
  swaps: {
    ...
    takeoverPrefundNote:
      "Οι ανταλλαγές στις οποίες δεν έχει κλειδωθεί ακόμη τίποτα συνεχίζονται μόνο αν αυτό το πορτοφόλι μπορεί να επαληθεύσει ότι η χρηματοδότησή τους είναι ασφαλής για αποστολή· διαφορετικά καταλήγουν σε καθαρή ακύρωση λίγα λεπτά μετά την ανάληψη. Σε καμία περίπτωση δεν κινδυνεύουν κεφάλαια.",
  ...
  narrate: {
    locking: "Κλειδώνουμε τα {coin} σας — η συναλλαγή κλειδώματος φεύγει τώρα. Από εδώ σας προστατεύουν τα timelocks· η ακύρωση δεν είναι πια το δίχτυ ασφαλείας.",
    awaitingOurLock: "Επόμενη κλειδώνει η δική σας πλευρά {coin} — τη στέλνει το μηχάνημα που οδηγεί αυτό το swap.",
  ...
  exit: {
    ...
    handoffFailed:
      "Δεν ήταν δυνατή η παράδοση της μηχανής για συνέχιση στο παρασκήνιο: {err}. Το Satchel παραμένει ανοιχτό και η μηχανή συνεχίζει να παρακολουθεί τις ανταλλαγές σας — διορθώστε το πρόβλημα και δοκιμάστε ξανά.",
  },
  unlock: {
