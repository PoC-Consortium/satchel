...
export const el: Bundle = {
  app: {
    name: "Satchel",
    tagline: "ανταλλαγές χωρίς εμπιστοσύνη",
  },
  ...
  makeOffer: {
    ...
    sameCoin: "Το νόμισμα που δίνετε και αυτό που λαμβάνετε πρέπει να διαφέρουν.",
  ...
  takeSlip: {
    open: "Επικόλληση απόκομματος",
    title: "Λήψη ιδιωτικής προσφοράς",
    intro:
  ...
  seed: {
    ...
    importPlaceholder: "λέξη1 λέξη2 λέξη3 …",
    ...
    createTitle: "Δημιουργία σπόρου",
    importTitle: "Εισαγωγή σπόρου",
    secureTitle: "Ασφάλιση {label}",
  ...
  settings: {
    ...
    feeStep: "Βήμα κλιμάκωσης RBF (%)",
    feeStepHint: "Πόσο επιθετικά ανεβαίνει το τέλος μιας κολλημένης δαπάνης σε κάθε πέρασμα του χρονοπρογραμματιστή. Προεπιλογή 50.",
    feeSave: "Αποθήκευση",
  ...
  coins: {
    ...
    backendCoreTitle: "Πορτοφόλι Core RPC",
    backendCoreDesc: "Το ίδιο το πορτοφόλι του κόμβου σας χρηματοδοτεί την ανταλλαγή και λαμβάνει τα έσοδα.",
    backendHardwareTitle: "Υλικό",
    backendHardwareDesc: "Υπογραφή Ledger / PSBT για το σκέλος χρηματοδότησης.",
    backendLater: "αργότερα",
    // CoinSetup dialog.
    ...
    backendUrlLabel: "Διεύθυνση(εις) URL backend κόμβου",
    backendUrlHint:
      "Πρώτη διεύθυνση URL = το ίδιο το πορτοφόλι του κόμβου σας (χρηματοδοτεί ανταλλαγές, λαμβάνει έσοδα). Προσθέστε διακομιστές Electrum (tcp://host:port) μετά από κόμματα για επιπλέον, ανεξάρτητες όψεις της αλυσίδας.",
    fundingWallet: "Πορτοφόλι χρηματοδότησης",
  ...
  wallets: {
    ...
    receive: "Λήψη",
    send: "Αποστολή",
    sendTo: "Αποστολή σε διεύθυνση",
    amount: "Ποσό",
    sendTitle: "Αποστολή {amount} {sym};",
    sendConfirmBody: "Προς {to}\n\nΑυτό δαπανά από το πορτοφόλι του δικού σας κόμβου και δεν μπορεί να αναιρεθεί.",
  },
  corkboard: {
    ...
    hiddenOffers:
      "{count} ακόμα προσφορά(ές) για ζεύγη που δεν έχετε συνδέσει. Ρυθμίστε και τα δύο νομίσματα για να τις διαπραγματευτείτε:",
    ...
    book: {
      ...
      takerNote: "Αποδεχόμενοι την, δίνετε {give} και λαμβάνετε {get}.",
  ...
  wizard: {
    welcome: "Καλώς ήρθατε στο Satchel",
    connectTitle: "Συνδεθείτε με τη μηχανή Pact",
    connectIntro:
      "Το Satchel είναι ένας ελαφρύς πελάτης της μηχανής Pact — του πυρήνα που κρατά τα κλειδιά σας και εκτελεί τις ανταλλαγές. Επιλέξτε πώς θα τη φτάσετε.",
    managed: "Εκτέλεση της ενσωματωμένης μηχανής Pact",
    managedDesc: "Το Satchel εκκινεί και επιβλέπει τη δική του μηχανή Pact. Συνιστάται.",
    external: "Σύνδεση με εξωτερική μηχανή Pact",
    externalDesc: "Κατευθύνετε σε μια μηχανή Pact που ήδη εκτελείτε (ορίστε SATCHEL_PACTD_URL + cookie πριν την εκκίνηση).",
    externalNote:
      "Η εξωτερική λειτουργία επιλέγεται μέσω μεταβλητών περιβάλλοντος πριν την εκκίνηση του Satchel. Επανεκκινήστε με ορισμένο το SATCHEL_PACTD_URL για να τη χρησιμοποιήσετε.",
    coinsTitle: "Προσθέστε τα νομίσματά σας",
    coinsIntro:
      "Αφού δημιουργηθεί ο merchant σας, συνδέστε κάθε νόμισμα με τον δικό σας κόμβο στις Ρυθμίσεις → Νομίσματα. Επιλέξτε ένα νόμισμα και ένα backend (δημόσιο Electrum για μηδενική ρύθμιση, ή τον δικό σας κόμβο)· το genesis ελέγχεται έναντι αυτού του δικτύου πριν αποθηκευτεί οτιδήποτε.",
    coinsTemplatesSoon: "Πρότυπα νομισμάτων με ένα κλικ φτάνουν εδώ σε μεταγενέστερη έκδοση.",
    back: "Πίσω",
    continue: "Συνέχεια",
  ...
  narrate: {
    ...
    redeemedB:
      "Διεκδικήσατε τα {b} — αναμονή επιβεβαίωσης. Τα κλειδωμένα {a} σας παραμένουν προστατευμένα μέχρι αυτό να οριστικοποιηθεί.",
