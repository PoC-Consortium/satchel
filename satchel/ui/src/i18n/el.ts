...
export const el: Bundle = {
  ...
  serverSync: {
    ...
    promptTitle: "Νέοι προτεινόμενοι διακομιστές Electrum",
    promptBody:
      "Διατίθενται ενημερωμένοι προεπιλεγμένοι διακομιστές Electrum. Η προσθήκη τους βελτιώνει την αξιοπιστία — οι υπάρχοντες διακομιστές σας διατηρούνται.",
    coinLine: "{coin} — {count} νέοι",
    add: "Προσθήκη διακομιστών",
    ignore: "Παράβλεψη",
  },
};
