...
export const ca: Bundle = {
  ...
  header: {
    ...
    coinOk: "{name} — connectat · {via} · cim {tip}",
  ...
  wallets: {
    ...
    degradedViewsTip: "{down} de {total} servidors Electrum caiguts — els servidors de reserva cobreixen.",
    intro:
    ...
    sendOverBalance: "Més que el saldo disponible per gastar (incloent-hi la comissió estimada).",
    feeLabel: "Comissió de xarxa — s'afegeix a més de l'import",
    fee_slow: "Lenta",
    fee_normal: "Normal",
    fee_fast: "Ràpida",
    fee_custom: "Personalitzada",
    feeRate: "{rate} sat/vB",
    feeNoEstimate: "sense dades",
    feeNoEstimatesNote:
      "Ara mateix no hi ha estimacions de comissió en directe — pot ser que el mercat de comissions estigui buit. Estableix una tarifa personalitzada.",
    feeCustomLabel: "Tarifa personalitzada (sat/vB)",
    feeCustomMin: "Mínim {min} sat/vB.",
    sendFeePreview: "Comissió de xarxa estimada: ~{fee} {sym} per a una transacció típica.",
    sendReview: "Revisa",
    sendBack: "Enrere",
    sendConfirmTitle: "Confirma l'enviament ({sym})",
    sendConfirmRecipient: "Destinatari",
    sendConfirmAmount: "Import",
    sendConfirmFee: "Comissió de xarxa (estimada)",
    sendConfirmFeeValue: "~{fee} {sym} ({rate} sat/vB)",
    sendConfirmTotal: "Total (aprox.)",
    sendIrreversible:
      "Les transaccions són irreversibles. Comprova bé l'adreça — les monedes enviades a una d'equivocada es perden.",
    ...
    bump: "Accelera",
    bumpHint:
      "Paga una comissió més alta perquè aquesta transacció pendent es confirmi abans (RBF).",
    bumpTitle: "Apuja la comissió ({sym})",
    bumpIntro:
      "Substitueix aquesta transacció pendent per una que pagui una comissió més alta (RBF). Ara paga ~{rate} sat/vB.",
    bumpNeedHigher: "Tria una tarifa per sobre dels ~{rate} sat/vB actuals.",
    bumpBroadcast: "Comissió apujada — el reemplaçament {txid}… és de camí ({sym}).",
    bumpConfirm: "Apuja la comissió",
  },
  corkboard: {
  ...
  relays: {
    title: "Xarxa",
    tabNostr: "Nostr",
    serversSubtitle: "Servidors Electrum per a {coin} — el servidor del moneder, les vistes actives i les reserves fredes. La salut s'observa només del trànsit real; els servidors en reserva no es contacten fins que són promoguts.",
    ...
    stateHealthy: "sa",
    stateDown: "caigut",
    stateUntested: "no provat",
    retryIn: "reintent en {secs}s",
    serverTip: "{requests} peticions · {failures} errors",
    serverErr: "darrer error: {error}",
    noServers: "Aquesta moneda no té servidors Electrum configurats.",
  ...
  narrate: {
    locking: "Bloquejant els teus {coin} — la transacció de bloqueig està sortint ara. A partir d'aquí et protegeixen els timelocks; cancel·lar ja no és la xarxa de seguretat.",
    awaitingOurLock: "El teu costat bloqueja {coin} a continuació — l'envia la màquina que dirigeix aquest intercanvi.",
